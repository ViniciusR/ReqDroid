...
public class TelaEditarEscopoActivity extends SherlockActivity{
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.editarescopo);   
   ...
   private void salvaAlteracoesDoProjeto()
   {
        ...
        final String tituloAtual = TelaVisaoGeralActivity.getTituloProjeto();
            ...
            public void onClick(View v) 
            {
              ...
              {  
                       ...
                       || (eTitulo.getText().toString().equals(tituloAtual)))
                  {
                    ...
                    TelaVisaoGeralActivity.setTituloProjeto(projeto.getTitulo());
                    finish();
                  }
