...
public class TelaRequisitoAtrasadoDetalhadoActivity extends SherlockActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.requisitoatrasadodetalhado);
        recebeRequisito();
        editaRequisito();
        removeRequisito();
        moveRequisito();
    ...
    {
        String texto = TelaRequisitosAtrasadosActivity.getRequisitoSelecionado();
        ...
        botaoEditarAutorRequisito = (Button)findViewById(R.id.botaoEditarAutorRequisitoAtrasado);
        ...
        autor = (TextView)findViewById(R.id.campoAutorRequisitoAtrasado);
            ...
            public void onClick(View v) {
                ...
                alertBoxConfirmaExclusao.setPositiveButton(R.string.alert_sim, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        String requisito = TelaRequisitosAtrasadosActivity.getRequisitoSelecionado();
                        TelaRequisitosAtrasadosActivity.atualizaListaRemovido(TelaRequisitosAtrasadosActivity.getPosicaoRequisitoSelecionado());
                        OperacoesRequisitosAtrasados.removeRequisitoBD(TelaRequisitoAtrasadoDetalhadoActivity.this, requisito,
                                                                       TelaVisaoGeralActivity.getIdProjeto());
                        finish();
                    }
                });
            ...
            public void onClick(View v) {
                ...
                alertbox.setPositiveButton(R.string.alert_sim, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        OperacoesRequisitosAtrasados.removeRequisitoBD(TelaRequisitoAtrasadoDetalhadoActivity.this, requisito,
                                                                       TelaVisaoGeralActivity.getIdProjeto());
                        OperacoesRequisitosAtrasados.moveRequisitoBD(TelaRequisitoAtrasadoDetalhadoActivity.this, requisito,
        ...
        alert.setPositiveButton(R.string.alert_salvar, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                if (!entrada.getText().toString().equals(""))
                {
                    ...
                    versao.setText(versaoRequisito + ".0");
                    TelaRequisitosAtrasadosActivity.atualizaLista(TelaRequisitosAtrasadosActivity.getPosicaoRequisitoSelecionado(),
                            entrada.getText().toString());

                    OperacoesRequisitosAtrasados.editaRequisitoBD(TelaRequisitoAtrasadoDetalhadoActivity.this, descricaoAtual,
