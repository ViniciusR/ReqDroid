 ...
 * @version 1.0
 */
public class TelaNovoProjetoActivity extends ActionBarActivity {
            ...
            public void onClick(View v) 
            {
              ...
              if (camposPreenchidos())
              {
                  if (!projetoExistente(eTitulo.getText().toString()))
                  {
                    ...
                    int idProjeto = (BDGerenciador.getInstance(TelaNovoProjetoActivity.this).getIdUltimoProjeto());
                    configuraCaracteristicasDoUsuarioPadrao(idProjeto);
                    projeto.setId(idProjeto);
                    ProjetoUtils.setIdProjeto(idProjeto);
                    ProjetoUtils.setTituloProjeto(tituloProjeto);
                    abreDrawerPrincipal();
                    finish();
                  }
                  else
     ...
     */
    private void abreDrawerPrincipal()
    {
       final Intent i = new Intent(TelaNovoProjetoActivity.this, DrawerPrincipalActivity.class);
       startActivity(i);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menusobre:
                Intent i = new Intent(TelaNovoProjetoActivity.this, TelaSobreActivity.class);
                startActivity(i);
                break;
        }
